...
- packs a compatibility tested version - current:
  [v0.6.18](https://github.com/dailymotion/hls.js/releases/tag/v0.6.18) - of hls.js
...
run your stream in the [hls.js demo player](http://streambox.fr/mse/hls.js-0.6.18/demo/).
...
<script src="//cdn.jsdelivr.net/hls.js/0.6.18/hls.min.js"></script>
