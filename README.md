...
- packs a compatibility tested version - current:
  [v0.8.2](https://github.com/video-dev/hls.js/releases/tag/v0.8.2) - of hls.js
...
run your stream in the [hls.js demo player](http://streambox.fr/mse/hls.js-0.8.2/demo/).
