...
- packs a compatibility tested version - current:
  [v0.7.6](https://github.com/video-dev/hls.js/releases/tag/v0.7.6) - of hls.js
...
run your stream in the [hls.js demo player](http://streambox.fr/mse/hls.js-0.7.6/demo/).
...
<script src="//cdn.jsdelivr.net/hls.js/0.7.6/hls.min.js"></script>
